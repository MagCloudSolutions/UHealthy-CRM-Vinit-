        ...
        <form action="home.php" method="post">
            <div class=" user-details">
                ...
                <div class="input-box">
                    ...
                    <input name="assignedto" type="text" placeholder="Assigned to whom?" required>
                </div>
                <div class="input-box">
                    <span class="details">Follow Up Date</span>
                    <input name="followupdate" type="date" placeholder="Enter Follow Up Date" required>
                </div>
                <div class="input-box">
                    <span class="details">Is Organic</span>
                    <input name="isorganic" type="text" placeholder="Enter True/False" required>
                </div>
                <div class="input-box">
                    <span class="details">Adset Name</span>
                    <input name="adsetname" type="text" placeholder="" required>
                </div>
                <div class="input-box">
                    <span class="details">Campaign</span>
                    <input name="compaign" type="text" placeholder="" required>
                </div>
                <div class="input-box">
                    <span class="details">Vehicle</span>
                    <input name="vehicle" type="text" placeholder="" required>
                </div>
                <div class="input-box">
                    <span class="details">Lead ID</span>
                    <input name="leadid" type="number" placeholder="Enter Lead Id" required>
                </div>
                <div class="input-box">
                    <span class="details">Customer Disclaimer</span>
                    <input name="customer" type="text" placeholder="" required>
                </div>
                <div class="input-box">
                    <span class="details">Home Listing</span>
                    <input name="home" type="text" placeholder="" required>
                </div>
                <div class="input-box">
                    <span class="details">Retail ID</span>
                    <input name="retailid" type="number" placeholder="Enter Retail Id" required>
                </div>
